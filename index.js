...
Assoc.prototype.list = function (type, params, cb) {
    ...
    // Return a stream with the expanded json representation of the row or
    // rows from assoc.get() or assoc.list() with children rows expanded.
